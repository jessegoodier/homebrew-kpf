class Kpf < Formula
  ...
  url "https://files.pythonhosted.org/packages/2a/b7/263533e7a37000041c2469c631cdcc05b63f5bbb8e3e73e091ae6dd415fe/kpf-0.1.13.tar.gz"
  sha256 "6765d17e45ee3328503d82ab71bc7c739327e821fc905d840d395d58f9b12220"
  license "MIT"
  ...
  def install
    ...
    system libexec/"bin/python", "-m", "pip", "install", "kpf==0.1.13"
  ...
  test do
    ...
    assert_match "kpf 0.1.13", version_output
  end
end