class Kpf < Formula
  ...
  url "https://files.pythonhosted.org/packages/a4/b8/2a5e712ab62d5711bedd5dacb017496fe491231cbcdb729ffe31e5c4af42/kpf-0.11.1.tar.gz"
  sha256 "0d28c074d3de36c3343b1082052b261ce67efddee35b6fdfa4d2b15e9c36bea4"
  license "MIT"
  ...
  def install
    ...
    system libexec/"bin/python", "-m", "pip", "install", "--ignore-requires-python", "kpf==0.11.1"
  ...
  test do
    ...
    assert_match "kpf 0.11.1", version_output
  end
end